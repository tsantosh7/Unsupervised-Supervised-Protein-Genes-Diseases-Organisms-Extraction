...
for f in all_filenames:
    print(f)
    temp_ = pd.read_csv(f, sep='\t', error_bad_lines=False, names = ['words', 'year', 'freq', 'papers'], header =None)
    # temp_['TF'] = temp_['freq'] * temp_['papers']
    temp = temp_[['words','freq']]
...
#export to csv
appended_data.to_csv(data_path+"1-grams_duplicates.csv", chunksize=1000, index=False, encoding='utf-8-sig')
